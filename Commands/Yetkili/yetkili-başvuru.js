...
let seviyebaş = ":thumbsup: ";
let seviyeileri = ":thumbsup: ";
let seviyeorta = ":thumbsup: ";
let seviyeson = ":thumbsup:";
...
exports.run = (client, message, args) => {
  ...
  client.channels.cache.get("994189446960382015").send(
    new Discord.MessageEmbed()
      .setColor("GREEN")
      ...
      .addField(
        ...
        ` Kullanıcı Adı: <@${message.author.id}> \n Kullanıcı ID: \`${
          message.author.id
        }\` \n İlgilenecek Yetkili: <@&yekilirolID> \n Tarih: \`${moment().format(
          "DD/MM/YYYY | H:mm:ss"
        )}\` `
      )
      .addField(
